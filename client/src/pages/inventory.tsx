            ...
            <tbody>
              {isLoading ? (
                ...
                filtered.map((p) => (
                  <tr
                    key={p.ID}
                    className="border-b border-border/30 hover:bg-black/[0.02] transition-colors group text-sm"
                  >
                    ...
                    <td className="p-3">
                      <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button
                          onClick={() => openEdit(p)}
                          className="p-1.5 text-primary hover:bg-primary/10 rounded-lg interactive-btn"
                        >
                          <Edit2 size={14} />
                        </button>
                        <button
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    type="number"
                    step="0.01"
                    className="input-field border-primary/50 bg-primary/5"
                    value={precioUnidad}
