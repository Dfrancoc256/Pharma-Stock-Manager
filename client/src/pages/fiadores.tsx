...
export default function FiadoresPage() {
  ...
  const activos = listaFiadores.filter((f) => f.Fiador_ID);
          ...
          <div className="divide-y divide-border/30">
            {conDeuda.map((f) => (
              <div
                ...
                data-testid={`row-fiador-${f.Fiador_ID}`}
              >
                <div>
                  <p className="font-bold text-foreground" data-testid={`text-nombre-${f.Fiador_ID}`}>
                    {f.Nombre}
                  </p>
          ...
          <div className="divide-y divide-border/30">
            {sinDeuda.map((f) => (
              <div
                ...
                data-testid={`row-fiador-aldía-${f.Fiador_ID}`}
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="glass-card rounded-3xl w-full max-w-sm p-8 animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => setIsAddOpen(false)} className="p-2 rounded-xl hover:bg-black/5">
                <X size={18} />
              </button>
            </div>
            <form
            ...
            >
              <div>
                ...
                <input
                  ...
                  data-testid="input-nombre-fiador"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  data-testid="input-telefono-fiador"
                />
              </div>
              <div>
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={createFiador.isPending}
                  className="flex-1 py-3 rounded-xl font-bold bg-primary text-white interactive-btn"
                  data-testid="button-guardar-fiador"
                >
